for(var i = 0; i < 303; i++) { var scriptId = 'u' + i; window[scriptId] = document.getElementById(scriptId); }
...
gv_vAlignTable['u297'] = 'center';gv_vAlignTable['u11'] = 'bottom';gv_vAlignTable['u13'] = 'center';gv_vAlignTable['u15'] = 'bottom';gv_vAlignTable['u17'] = 'center';gv_vAlignTable['u300'] = 'center';u302.tabIndex = 0;
...
if (true) {
	...
	MoveWidgetBy('u295', GetNum('-786'), GetNum('0'),'swing',500);

	MoveWidgetBy('u298', GetNum('-786'), GetNum('0'),'swing',500);
...
if (true) {
	...
	MoveWidgetBy('u298', GetNum('-50'), GetNum('0'),'swing',500);

	MoveWidgetBy('u295', GetNum('-50'), GetNum('0'),'swing',500);
