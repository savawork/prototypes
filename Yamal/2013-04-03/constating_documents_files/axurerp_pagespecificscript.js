for(var i = 0; i < 333; i++) { var scriptId = 'u' + i; window[scriptId] = document.getElementById(scriptId); }
...
if (true) {
	...
	SetPanelState('u259', 'pd2u259','none','',500,'none','',500);
